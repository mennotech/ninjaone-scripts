...
# ==============================================================================
# Script Name: Deploy Wi-Fi Profile
# ==============================================================================
#
# Description:
...
#   - authenticationType (DROPDOWN, Required): Select either WPA2 authentication or WPA3.
#     Default: WPA2PSK
#   - nameOfASecureCustomFieldContainingPresharedKey (TEXT, Required): Specify the name of a secure custom field that contains the preshared key.
#   - overwrite (CHECKBOX, Optional): If the profile already exists overwrite it.
#     Default: false
#
# ==============================================================================
...
<#
.SYNOPSIS
    Deploys a Wi-Fi profile to all users on a device.
.DESCRIPTION
    This script deploys a Wi-Fi profile to all users on a device. It retrieves the preshared key from a secure custom field, creates an XML profile, and imports it using netsh.
    The script requires administrative privileges to run.

    The script can be run with the following parameters:
        -SSID: Specifies the Wi-Fi SSID/name.
        -AuthType: Select either WPA2 authentication or WPA3. Default is "WPA2PSK".
...
.NOTES
    2023-10-18: Initial version of the script.
.LINK
    https://github.com/mennotech/rmm-scripts/blob/main/powershell/Deploy-Wi-Fi-Profile.ps1
.LICENSE
