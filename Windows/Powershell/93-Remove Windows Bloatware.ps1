...
#
# Description:
#   Removes AppX common bloatware that is often pre-installed on a PC.
#
# Metadata:
...
#   - Last Updated: 2025-06-02 18:16:58
#   - Active: True
# Script Variables (NinjaOne):
#   - appsToRemove (TEXT, Optional): A comma-separated list of Appx package names you would like to remove.
#   - overrideWithCustomFieldName (TEXT, Optional): Name of a multiline custom field to retrieve the 'Apps To Remove' list.
#     Default: AppsToRemove
#
# ==============================================================================
